...
class AppColors {
  ...
  static const Color dashedLineColor = Color(0xFFCECED5);
  static const Color blackColor = Color(0xFF040303);
  ...
  static const Color textFieldColor = Color.fromARGB(255, 240, 240, 240);
